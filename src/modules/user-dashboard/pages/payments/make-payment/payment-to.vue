...
import SaveTemplateForm from '@/modules/user-dashboard/pages/payments/make-payment/components/save-template-form.vue';
import TransferDetails from '@/modules/user-dashboard/pages/payments/make-payment/components/transfer-details.vue';
